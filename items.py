...
def random_item(z, typ=None, subtyp=None):
    ...
    item_dict = {'Weapon': {'Dagger': [[Dirk, Baselard, Kris, Rondel, Kukri],
                                       [Dirk().rarity, Baselard().rarity, Kris().rarity, Rondel().rarity,
                                        Kukri().rarity],
                                       ['1', '2', '3', '4', '5']],
                            'Sword': [[Rapier, Jian, Talwar, Shamshir, Khopesh],
                                      [Rapier().rarity, Jian().rarity, Talwar().rarity, Shamshir().rarity,
                                       Khopesh().rarity],
                                      ['1', '2', '3', '4', '5']],
                            'Club': [[Mace, WarHammer, Pernach, Morgenstern],
                                     [Mace().rarity, WarHammer().rarity, Pernach().rarity, Morgenstern().rarity],
                                     ['1', '2', '4', '5']],
                            'Fist': [[BrassKnuckles, Cestus, BattleGauntlet, BaghNahk],
                                     [BrassKnuckles().rarity, Cestus().rarity, BattleGauntlet().rarity,
                                      BaghNahk().rarity],
                                     ['2', '3', '4', '5']],
                            'Ninja Blade': [[Tanto, Wakizashi],
                                            [Tanto().rarity, Wakizashi().rarity],
                                            ['4', '5']],
                            'Longsword': [[Bastard, Claymore, Zweihander, Changdao, Flamberge],
                                          [Bastard().rarity, Claymore().rarity, Zweihander().rarity, Changdao().rarity,
                                           Flamberge().rarity],
                                          ['1', '2', '3', '4', '5']],
                            'Battle Axe': [[Mattock, Broadaxe, DoubleAxe, Parashu, Greataxe],
                                           [Mattock().rarity, Broadaxe().rarity, DoubleAxe().rarity, Parashu().rarity,
                                            Greataxe().rarity],
                                           ['1', '2', '3', '4', '5']],
                            'Polearm': [[Voulge, Partisan, Halberd, Naginata, Trident],
                                        [Voulge().rarity, Partisan().rarity, Halberd().rarity, Naginata().rarity,
                                         Trident().rarity],
                                        ['1', '2', '3', '4', '5']],
                            'Staff': [[Quarterstaff, Baston, IronshodStaff, SerpentStaff, HolyStaff, RuneStaff,
                                       MithrilshodStaff],
                                      [Quarterstaff().rarity, Baston().rarity, IronshodStaff().rarity,
                                       SerpentStaff().rarity, HolyStaff().rarity, RuneStaff().rarity,
                                       MithrilshodStaff().rarity],
                                      ['1', '1', '2', '3', '4', '5', '5']],
                            'Hammer': [[Sledgehammer, Maul, EarthHammer, GreatMaul],
                                       [Sledgehammer().rarity, Maul().rarity, EarthHammer().rarity, GreatMaul().rarity],
                                       ['1', '2', '4', '5']],
                            },
                 'OffHand': {'Shield': [[Buckler, Aspis, Targe, Glagwa, KiteShield, Pavise],
                                        [Buckler().rarity, Aspis().rarity, Targe().rarity, Glagwa().rarity,
                                         KiteShield().rarity, Pavise().rarity],
                                        ['1', '1', '2', '3', '4', '4']],
                             'Tome': [[Book, TomeKnowledge, Grimoire, BookShadows, DragonRouge, Vedas, Necronomicon],
                                      [Book().rarity, TomeKnowledge().rarity, Grimoire().rarity, BookShadows().rarity,
                                       DragonRouge().rarity, Vedas().rarity, Necronomicon().rarity],
                                      ['1', '2', '3', '3', '4', '4', '5']]},
                 'Armor': {'Cloth': [[Tunic, ClothCloak, SilverCloak, GoldCloak, CloakEnchantment, WizardRobe],
                                     [Tunic().rarity, ClothCloak().rarity, SilverCloak().rarity, GoldCloak().rarity,
                                      CloakEnchantment().rarity, WizardRobe().rarity],
                                     ['1', '1', '2', '3', '4', '5']],
                           'Light': [[PaddedArmor, LeatherArmor, Cuirboulli, StuddedLeather, StuddedCuirboulli],
                                     [PaddedArmor().rarity, LeatherArmor().rarity, Cuirboulli().rarity,
                                      StuddedLeather().rarity, StuddedCuirboulli().rarity],
                                     ['1', '1', '2', '3', '4']],
                           'Medium': [[HideArmor, ChainShirt, ScaleMail, Breastplate, HalfPlate],
                                      [HideArmor().rarity, ChainShirt().rarity, ScaleMail().rarity,
                                       Breastplate().rarity, HalfPlate().rarity],
                                      ['1', '1', '2', '3', '4']],
                           'Heavy': [[RingMail, ChainMail, Splint, PlateMail, FullPlate],
                                     [RingMail().rarity, ChainMail().rarity, Splint().rarity, PlateMail().rarity,
                                      FullPlate().rarity],
                                     ['1', '1', '2', '3', '4']]},
                 'Accessory': {'Ring': [[IronRing, PowerRing, AccuracyRing, BarrierRing, SteelRing, MightRing,
                                         EvasionRing, TitaniumRing, ForceRing],
                                        [IronRing().rarity, PowerRing().rarity, AccuracyRing().rarity,
                                         BarrierRing().rarity, SteelRing().rarity, MightRing().rarity,
                                         EvasionRing().rarity, TitaniumRing().rarity, ForceRing().rarity],
                                        ['1', '2', '3', '3', '4', '4', '5', '6', '6']],
                               'Pendant': [[VisionPendant, RubyAmulet, SilverPendant, AntidotePendant, SapphireAmulet,
                                           ...
                                           [VisionPendant().rarity, RubyAmulet().rarity, SilverPendant().rarity,
                                            AntidotePendant().rarity, SapphireAmulet().rarity, GoldPendant().rarity,
                                            GorgonPendant().rarity, DharmaPendant().rarity, LevitationNecklace().rarity,
                                            InvisibilityAmulet().rarity, DiamondAmulet().rarity,
                                            PlatinumPendant().rarity],
                                           ['1', '2', '2', '2', '3', '3', '3', '4', '4', '5', '6', '6']],
                               },
                 'Potion': {'Health': [[HealthPotion, GreatHealthPotion, SuperHealthPotion, MasterHealthPotion],
                                       [HealthPotion().rarity, GreatHealthPotion().rarity, SuperHealthPotion().rarity,
                                        MasterHealthPotion().rarity],
                                       ['1', '2', '3', '4']],
                            'Mana': [[ManaPotion, GreatManaPotion, SuperManaPotion, MasterManaPotion],
                                     [ManaPotion().rarity, GreatManaPotion().rarity, SuperManaPotion().rarity,
                                      MasterManaPotion().rarity],
                                     ['1', '2', '3', '4']],
                            'Elixir': [[Elixir, Megalixir],
                                       [Elixir().rarity, Megalixir().rarity],
                                       ['3', '5']],
                            'Stat': [[HPPotion, MPPotion, StrengthPotion, IntelPotion, WisdomPotion, ConPotion,
                                      CharismaPotion, DexterityPotion, AardBeing],
                                     [HPPotion().rarity, MPPotion().rarity, StrengthPotion().rarity,
                                      IntelPotion().rarity, WisdomPotion().rarity, ConPotion().rarity,
                                      CharismaPotion().rarity, DexterityPotion().rarity, AardBeing().rarity],
                                     ['1', '1', '2', '2', '2', '2', '2', '2', '6']],
                            'Status': [[Antidote, EyeDrop, AntiCoagulant, PhoenixDown],
                                       [Antidote().rarity, EyeDrop().rarity, AntiCoagulant().rarity,
                                        PhoenixDown().rarity],
                                       ['1', '1', '2', '4']]
                            },
                 'Misc': {'Key': [[Key, OldKey],
                                  [Key().rarity, OldKey().rarity],
                                  ['1', '2']],
                          'Scroll': [[BlessScroll, SleepScroll, FireScroll, IceScroll, ElectricScroll, WaterScroll,
                                     ...
                                     [BlessScroll().rarity, SleepScroll().rarity, FireScroll().rarity,
                                      IceScroll().rarity, ElectricScroll().rarity, WaterScroll().rarity,
                                      EarthScroll().rarity, WindScroll().rarity, ShadowScroll().rarity,
                                      HolyScroll().rarity, RegenScroll().rarity, SilenceScroll().rarity,
                                      DispelScroll().rarity, DeathScroll().rarity, SanctuaryScroll().rarity,
                                      UltimaScroll().rarity],
    ...
    while True:
        ...
        try:
            inds = list(range(levels.index(str(z)), len(levels)))
        except ValueError:
        ...
        if treasure().rarity > random.random():
            break
    return treasure
...
class NoWeapon(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Bare Hands", description="Nothing but your fists.",
                         value=0, rarity=0, damage=0, crit=0.025, handed=1, subtyp='None', unequip=True,
                         off=True)
...
class BaghNahk(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Bagh Nahk", description="The bagh nahk is a 'fist-load, claw-like' dagger designed to "
                                                       ...
                                                       "palm.",
                         value=30000, rarity=0.1, damage=8, crit=0.25, handed=1, subtyp='Fist', unequip=False,
                         off=True)
...
class Kukri(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Kukri", description="A kukri is a type of dagger with a distinct recurve in its blade.",
                         value=20000, rarity=0.1, damage=10, crit=0.4, handed=1, subtyp='Dagger', unequip=False,
                         off=True)
...
class Khopesh(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Khopesh", description="A khopesh is a sickle-shaped sword that evolved from battle axes"
                         ...
                         value=22000, rarity=0.1, damage=12, crit=0.25, handed=1, subtyp='Sword', unequip=False,
                         off=True)
        self.special = True
...
class Morgenstern(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Morgenstern", description="A morgenstern, or morning star, is a club-like weapon "
                                                         ...
                                                         "several spikes.",
                         value=21000, rarity=0.1, damage=14, crit=0.15, handed=1, subtyp='Club', unequip=False,
                         off=True)
...
class Tanto(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Tanto", description="A tanto is a double-edged, straight blade, designed primarily as a "
                         ...
                         value=15000, rarity=0.3, damage=8, crit=0.33, handed=1, subtyp='Ninja Blade', unequip=False,
                         off=True)
...
class Wakizashi(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Wakizashi", description="A wakizashi is a curved, single-edged blade with a narrow "
                         ...
                         value=65000, rarity=0.1, damage=12, crit=0.4, handed=1, subtyp='Ninja Blade', unequip=False,
                         off=True)
        self.restriction = ['Ninja']
...
class Bastard(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Bastard Sword", description="The bastard sword, also referred to as a hand-and-a-half "
                                                           ...
                                                           "arises.",
                         value=700, rarity=0.9, damage=5, crit=0.1, handed=2, subtyp='Longsword', unequip=False, off=False)
...
class Changdao(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Changdao", description="A single-edged two-hander over seven feet long, roughly "
                         ...
                         value=16000, rarity=0.25, damage=13, crit=0.25, handed=2, subtyp='Longsword', unequip=False,
                         off=False)
...
class Flamberge(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Flamberge", description="The flamberge is a type of flame-bladed sword featuring a "
                         ...
                         value=31000, rarity=0.1, damage=15, crit=0.33, handed=2, subtyp='Longsword', unequip=False,
                         off=False)
...
class Executioner(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Executioner's Blade", description="Designed specifically for decapitation, the "
                         ...
                         value=0, rarity=0, damage=21, crit=0.4, handed=2, subtyp='Longsword', unequip=False, off=False)
        self.special = True
        self.ultimate = True
...
class Mattock(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Mattock", description="A mattock is a hand tool used for digging, prying, and chopping, "
                         ...
                         value=800, rarity=0.9, damage=6, crit=0.1, handed=2, subtyp='Battle Axe', unequip=False, off=False)
...
class Parashu(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Parashu", description="A parashu is a single-bladed battle axe with an arced edge "
                                                     ...
                                                     "cutting edge.",
                         value=15000, rarity=0.25, damage=14, crit=0.25, handed=2, subtyp='Battle Axe', unequip=False,
                         off=False)
...
class Greataxe(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Greataxe", description="A greataxe is a scaled up version of the double axe with greater"
                         ...
                         value=30000, rarity=0.1, damage=16, crit=0.3, handed=2, subtyp='Battle Axe', unequip=False,
                         off=False)
...
class Naginata(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Naginata", description="A naginata consists of a wooden or metal pole with a curved "
                                                      ...
                                                      " the blade and shaft.",
                         value=13000, rarity=0.25, damage=13, crit=0.3, handed=2, subtyp='Polearm', unequip=False,
                         off=False)
...
class Trident(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Trident", description="A trident is a 3-pronged spear, the preferred weapon of the Sea"
                                                     " god Poseidon.",
                         value=26000, rarity=0.1, damage=15, crit=0.33, handed=2, subtyp='Polearm', unequip=False,
                         off=False)
...
class MithrilshodStaff(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Mithrilshod Staff", description="A mithril walking stick, making it ideal for striking.",
                         value=20000, rarity=0.1, damage=14, crit=0.2, handed=2, subtyp='Staff', unequip=False,
                         off=False)
...
class EarthHammer(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Earth Hammer", description="A large, 2-handed hammer infused with the power of Gaia.",
                         value=12000, rarity=0.35, damage=18, crit=0.15, handed=2, subtyp='Hammer', unequip=False,
                         off=False)
        self.special = True
...
class GreatMaul(Weapon):
    ...
    def __init__(self):
        super().__init__(name="Great Maul", description="A great maul looks similar to a sledgehammer but is "
                         ...
                         value=27000, rarity=0.1, damage=20, crit=0.2, handed=2, subtyp='Hammer', unequip=False,
                         off=False)
...
class CloakEnchantment(Armor):
    ...
    def __init__(self):
        super().__init__(name="Cloak of Enchantment", description="A magical cloak that shields the wearer from all "
                                                                  "forms of attack.",
                         value=15000, rarity=0.25, armor=7, subtyp='Cloth', unequip=False)
...
class WizardRobe(Armor):
    ...
    def __init__(self):
        super().__init__(name="Wizard's Robe", description="A knee-length, long-sleeved robe with an impressive hood "
                         ...
                         value=25000, rarity=0.1, armor=10, subtyp='Cloth', unequip=False)
...
class MerlinRobe(Armor):
    ...
    def __init__(self):
        super().__init__(name="Robes of Merlin", description="The enchanted robes of Merlin the enchanter.",
                         value=75000, rarity=0.01, armor=12, subtyp='Cloth', unequip=False)
...
class StuddedLeather(Armor):
    ...
    def __init__(self):
        super().__init__(name="Studded Leather", description="Leather armor embedded with iron studs to improve "
                         ...
                         value=12000, rarity=0.25, armor=8, subtyp='Light', unequip=False)
...
class StuddedCuirboulli(Armor):
    ...
    def __init__(self):
        super().__init__(name="Studded Cuirboulli", description="Boiled leather armor embedded with iron studs to "
                         ...
                         value=28000, rarity=0.1, armor=12, subtyp='Light', unequip=False)
...
class DragonHide(Armor):
    ...
    def __init__(self):
        super().__init__(name="Dragon Hide", description="Hide armor made from the scales of a red dragon, "
                         ...
                         value=80000, rarity=0.01, armor=16, subtyp='Light', unequip=False)
...
class Breastplate(Armor):
    ...
    def __init__(self):
        super().__init__(name="Breastplate", description="Armor consisting of a fitted metal chest piece worn with "
                         ...
                         value=14000, rarity=0.25, armor=9, subtyp='Medium', unequip=False)
...
class HalfPlate(Armor):
    ...
    def __init__(self):
        super().__init__(name="Half Plate", description="Armor consisting of shaped metal plates that cover most of the"
                         ...
                         value=30000, rarity=0.1, armor=13, subtyp='Medium', unequip=False)
...
class Aegis(Armor):
    ...
    def __init__(self):
        super().__init__(name="Aegis Breastplate", description="The breastplate of Zeus, emboldened with a bolt of "
                                                               "lightning.",
                         value=90000, rarity=0.01, armor=18, subtyp='Medium', unequip=False)
...
class PlateMail(Armor):
    ...
    def __init__(self):
        super().__init__(name="Plate Mail", description="Armor consisting of shaped, interlocking metal plates to "
                         ...
                         value=20000, rarity=0.25, armor=10, subtyp='Heavy', unequip=False)
...
class FullPlate(Armor):
    ...
    def __init__(self):
        super().__init__(name="Full Plate", description="Armor consisting of shaped, interlocking metal plates to "
                         ...
                         value=40000, rarity=0.1, armor=15, subtyp='Heavy', unequip=False)
...
class Genji(Armor):
    ...
    def __init__(self):
        super().__init__(name="Genji Armor", description="Mythical armor crafted by an unknown master blacksmith and "
                                                         ...
                                                         "shrug off damage.",
                         value=100000, rarity=0.01, armor=25, subtyp='Heavy', unequip=False)
...
class Necronomicon(OffHand):
    ...
    def __init__(self):
        super().__init__(name="Necronomicon", description="The Book of the Dead, a mystical grimoire written by an "
                                                          "unknown author.",
                         value=40000, rarity=0.05, mod=20, subtyp='Tome', unequip=False)
...
class SteelRing(Accessory):
    ...
    def __init__(self):
        super().__init__(name="Steel Ring", description="A ring that greatly improves the wearer's defense.",
                         value=18000, rarity=0.2, mod="+5 Physical Defense", subtyp="Ring", unequip=False)
...
class MightRing(Accessory):
    ...
    def __init__(self):
        super().__init__(name="Might Ring", description="A ring that greatly improves the wearer's attack damage.",
                         value=24000, rarity=0.2, mod="+10 Physical Damage", subtyp="Ring", unequip=False)
...
class EvasionRing(Accessory):
    ...
    def __init__(self):
        super().__init__(name="Evasion Ring", description="A ring that improves the wearer's chance to dodge.",
                         value=40000, rarity=0.1, mod="Dodge", subtyp="Ring", unequip=False)
...
class TitaniumRing(Accessory):
    ...
    def __init__(self):
        super().__init__(name="Titanium Ring", description="A ring that massively improves the wearer's defense.",
                         value=45000, rarity=0.05, mod="+10 Physical Defense", subtyp="Ring", unequip=False)
...
class ForceRing(Accessory):
    ...
    def __init__(self):
        super().__init__(name="Force Ring", description="A ring that massively improves the wearer's attack damage.",
                         value=50000, rarity=0.05, mod="+25 Physical Damage", subtyp="Ring", unequip=False)
...
class DharmaPendant(Accessory):
    ...
    def __init__(self):
        super().__init__(name="Dharma Pendant", description="No need to fear the reaper while wearing this ring, giving"
                         ...
                         value=25000, rarity=0.1, mod="Death", subtyp="Pendant", unequip=False)
...
class LevitationNecklace(Accessory):
    ...
    def __init__(self):
        super().__init__(name="Levitation Necklace", description="Gives the wearer the ability to fly, making them "
                         ...
                         value=30000, rarity=0.1, mod="Flying", subtyp="Pendant", unequip=False)
...
class InvisibilityAmulet(Accessory):
    ...
    def __init__(self):
        super().__init__(name="Invisibility Amulet", description="Makes the wearer invisible and harder to hit.",
                         value=50000, rarity=0.05, mod="Invisible", subtyp="Pendant", unequip=False)
...
class DiamondAmulet(Accessory):
    ...
    def __init__(self):
        super().__init__(name="Diamond Amulet", description="A diamond necklace that massively improves the wearer's "
                                                            "magic damage.",
                         value=55000, rarity=0.05, mod="+25 Magic Defense", subtyp="Pendant", unequip=False)
...
class PlatinumPendant(Accessory):
    ...
    def __init__(self):
        super().__init__(name="Platinum Pendant", description="A platinum-chained necklace that massively improves the "
                         ...
                         value=60000, rarity=0.05, mod="+25 Magic Damage", subtyp="Pendant", unequip=False)
...
class ElementalAmulet(Accessory):
    ...
    def __init__(self):
        super().__init__(name="Elemental Amulet", description="Fashioned from the cores of elementals, this necklace "
                                                              ...
                                                              "and wind.",
                         value=100000, rarity=0.01, mod="Elemental", subtyp="Pendant", unequip=False)
...
class HealthPotion(Potion):
    ...
    def __init__(self):
        super().__init__(name="Health Potion", description="A potion that restores up to 25% of your health.",
                         value=100, rarity=0.5, subtyp='Health')
        self.percent = 0.25
...
class ManaPotion(Potion):
    ...
    def __init__(self):
        super().__init__(name="Mana Potion", description="A potion that restores up to 25% of your mana.",
                         value=250, rarity=0.4, subtyp='Mana')
        self.percent = 0.25
...
items_dict = {'Weapon': {'Fist': [BrassKnuckles, Cestus, BattleGauntlet, BaghNahk],
              ...
              'Armor': {'Cloth': [Tunic, ClothCloak, SilverCloak, GoldCloak, WizardRobe, CloakEnchantment],
                        ...
                        'Medium': [HideArmor, ChainShirt, ScaleMail, Breastplate, HalfPlate],
                        'Heavy': [RingMail, ChainMail, Splint, PlateMail, FullPlate]},
              'Accessory': {'Ring': [IronRing, PowerRing, AccuracyRing, BarrierRing, SteelRing, MightRing, EvasionRing],
                            'Pendant': [VisionPendant, RubyAmulet, SilverPendant, AntidotePendant, SapphireAmulet,
                                        GoldPendant, GorgonPendant, DharmaPendant, LevitationNecklace,
                                        InvisibilityAmulet]},
              'Potion': {'Health': [HealthPotion, GreatHealthPotion, SuperHealthPotion, MasterHealthPotion],
