...
from gui.dungeon_hud import DungeonHUD
from gui.combat_manager import GUICombatManager
from gui.character_screen import CharacterScreen
from gui.loot_popup import LootPopup
...
class DungeonManager:
    ...
    def move_forward(self):
        ...
        try:
            ...
            print(f"[DEBUG] Step: pos=({x},{y},{z}), facing={self.player_char.facing}, tile={tname}")
    ...
    def _check_tile_effects(self):
        ...
        try:
            ...
            print(f"[DEBUG] modify_player error on {type(current_tile).__name__}: {e}")
        else:
