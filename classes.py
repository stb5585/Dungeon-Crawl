    ...
    while True:
        ...
        if confirm.navigate_popup():
            ...
            if (
                ...
                in abilities.spell_dict[promoted_player.cls.name]
            ):
                spell_gain = abilities.spell_dict[promoted_player.cls.name][
                    str(promoted_player.level.level)
                ]()
            ...
            if (
                str(promoted_player.level.level)
                in abilities.skill_dict[promoted_player.cls.name]
            ):
                skill_gain = abilities.skill_dict[promoted_player.cls.name][
                    str(promoted_player.level.level)
                ]()
