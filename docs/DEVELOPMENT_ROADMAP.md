...
1. Complete modern Character Menu acceptance and iteration.
   ...
   - Implemented: generic Character/Equipment tabs, shorter right-column level-progress bar, larger portrait placeholder, larger character/combat/resistance text, panel dividers, spread-out paper-doll Equipment tab with Helmet UI placeholder, grouped weaknesses/resistances, equipment-buff reporting, and town/dungeon opt-in routing.
