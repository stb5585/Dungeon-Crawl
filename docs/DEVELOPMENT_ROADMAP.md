...
1. Complete modern Character Menu acceptance and iteration.
   ...
   - Implemented: generic Character/Equipment tabs, shorter non-overlapping level-progress bar, larger portrait placeholder, larger character/combat stat text, spread-out paper-doll Equipment tab with Helmet UI placeholder, grouped weaknesses/resistances, equipment-buff reporting, and town/dungeon opt-in routing.
