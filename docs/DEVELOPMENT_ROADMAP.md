...
1. Complete modern Character Menu acceptance and iteration.
   ...
   - Implemented: generic Character/Equipment tabs, clarified non-overlapping level-progress bar, portrait placeholder, combat-stat block, Helmet UI placeholder, richer equipment summaries/details, grouped weaknesses/resistances, equipment-buff reporting, and town/dungeon opt-in routing.
