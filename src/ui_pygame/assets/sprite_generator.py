...
class SpriteGenerator:
    ...
    def create_monster_sprite(
        ...
        if sprite_type == "blob":  # Slimes, oozes
            ...
            # Tail
            pygame.draw.line(
                surface, color, (center_x - 15, center_y), (center_x - 22, center_y - 8), 3
            )
            ...
            # Tail
            pygame.draw.line(
                surface, color, (center_x - 18, center_y + 5), (center_x - 28, center_y + 15), 4
            )
            ...
            # Arms (bones)
            pygame.draw.line(
                surface, color, (center_x - 10, center_y + 2), (center_x - 16, center_y + 12), 3
            )
            pygame.draw.line(
                surface, color, (center_x + 10, center_y + 2), (center_x + 16, center_y + 12), 3
            )
            # Legs (bones)
            pygame.draw.line(
                surface, color, (center_x - 4, center_y + 18), (center_x - 6, center_y + 30), 3
            )
            pygame.draw.line(
                surface, color, (center_x + 4, center_y + 18), (center_x + 6, center_y + 30), 3
            )
        ...
        if icon_type == "stun":
            ...
            for i in range(3):
                ...
                for j in range(5):
                    ...
                    points.append((x + int(radius * math.cos(a)), y + int(radius * math.sin(a))))
                pygame.draw.polygon(surface, color, points)
            ...
            # Crossbones
            pygame.draw.line(
                surface, color, (center_x - 8, center_y + 8), (center_x + 8, center_y + 8), 3
            )
...
def generate_all_sprites():
    ...
    # Player classes
    sprite_gen.create_humanoid_sprite(
        "player_warrior", COLORS["player_blue"], has_weapon=True, has_shield=True
    )
    sprite_gen.create_humanoid_sprite("player_mage", COLORS["player_light_blue"], has_weapon=False)
    sprite_gen.create_humanoid_sprite("player_rogue", (80, 80, 120), has_weapon=True)
    sprite_gen.create_humanoid_sprite("player_cleric", (200, 200, 100), has_shield=True)
