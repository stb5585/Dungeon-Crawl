...
class StatSelectionPopup:
    ...
    def __init__(self, presenter, stat_options):
        ...
        # Fonts
        self.title_font = (
            presenter.title_font if hasattr(presenter, "title_font") else pygame.font.Font(None, 48)
        )
        self.normal_font = (
        ...
        self.small_font = (
            presenter.small_font if hasattr(presenter, "small_font") else pygame.font.Font(None, 24)
        )
    ...
    def draw_popup(self):
        ...
        for i, (stat_name, stat_value) in enumerate(self.stat_options):
            ...
            stat_text = self.normal_font.render(
                f"{stat_name}: {stat_value} -> {stat_value + 1}", True, text_color
            )
        ...
        instruction_text = self.small_font.render(
            "Up/Down or W/S to select | Enter to confirm", True, self.GRAY
        )
