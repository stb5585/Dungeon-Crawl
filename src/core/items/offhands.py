...
class NoOffHand(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="No OffHand",
            description="No off-hand equipped.",
            value=0,
            rarity=0,
            mod=0,
            subtyp="None",
...
class Buckler(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Buckler",
            description="A small round shield held by a handle or worn on the forearm.",
            value=25,
            rarity=0.95,
            mod=0.05,
            subtyp="Shield",
...
class Aspis(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Aspis",
            description="An aspis is a heavy wooden shield with a handle at the edge and is "
...
class Targe(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Targe",
            description="A targe is a circular, concave shield fitted with straps on the "
...
class Glagwa(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Glagwa",
            description="A glagwa is a bell-shaped shield made from iron and covered with "
...
class KiteShield(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Kite Shield",
            description="A kite shield is a large, almond-shaped shield rounded at the"
...
class Pavise(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Pavise",
            description="A pavise is an oblong shield similar to a tower shield that "
...
class Svalinn(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Svalinn",
            description="The svalinn is a mythical shield that symbolizes protection "
...
class MedusaShield(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Medusa Shield",
            description="A shield that has been polished to resemble a mirror. Said"
...
class NaturalShield(OffHand):
    ...
    def __init__(self, name: str, mod: float, subtyp: str) -> None:
        super().__init__(
            name=name, mod=mod, subtyp=subtyp, description="", rarity=0, unequip=False, value=0
        )
        self.name = name
        self.mod = mod
        self.subtyp = subtyp
...
class Book(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Book",
            description="A book of notes taken during the character's apprenticeship.",
            value=25,
            rarity=0.95,
            mod=6,
            subtyp="Tome",
...
class TomeKnowledge(OffHand):
    ...
    def __init__(self):
        super().__init__(
            ...
            description="A tome containing secrets to enhancing spells.",
            value=500,
            rarity=0.9,
            mod=14,
            subtyp="Tome",
...
class InfernalGrimoire(OffHand):
    ...
    def __init__(self):
        super().__init__(
            ...
            description="A blackened, flame-wreathed book that burns to the "
...
class ElementalPrimer(OffHand):
    ...
    def __init__(self):
        super().__init__(
            ...
            description="A multi-colored tome that shifts between elemental "
...
class TreatiseBalance(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Treatise of Balance",
            description="A weathered tome, marked with a taijitu, better "
...
class DragonRouge(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Dragon Rouge",
            description='French for "Red Dragon", this mythical tome contains '
...
class Vedas(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Vedas",
            description="A large body of religious texts, consisting of some of the oldest "
            "holy teachings.",
            value=50000,
            rarity=0.4,
            mod=54,
...
class CompendiumAncients(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Compendium of the Ancients",
            description="A colossal tome filled with records of "
...
class Necronomicon(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Necronomicon",
            description="The Book of the Dead, a mystical grimoire written by an "
            "unknown author.",
            value=72000,
            rarity=0.2,
            mod=75,
...
class Magus(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Magus",
            description="A book of magical art written by a powerful wizard.",
            value=90000,
            rarity=0.05,
            mod=90,
            subtyp="Tome",
...
class CodexEternity(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Codex of Eternity",
            description="A shimmering tome bound in starlight, with pages that "
...
class WillowDiviningRod(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Willow Divining Rod",
            description="A fresh willow switch wrapped in copper thread. "
...
class CopperLeyRod(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Copper Ley Rod",
            description="A straight copper rod etched with ley-line marks. "
...
class MoonlitHazelRod(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Moonlit Hazel Rod",
            description="Hazel harvested under a clear moon and capped with "
...
class DowsingRod(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Dowsing Rod",
            description="Also known as a divining rod, this oak Y-shaped branch "
...
class ScepterIfrit(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Scepter of Ifrit",
            description="A flaming scepter imbued by the wrath of Ifrit. All "
...
class GaiasBranch(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Gaia's Branch",
            description="Mother Earth embodies all the living things, including the"
...
class Zephyruswand(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Zephyruswand",
            description="As the God of the West Wind, Zephyrus lends his power to "
...
class RainbowRod(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Rainbow Rod",
            description="A radiant rod imbued with the essence of every elemental "
...
class UltimaScepter(OffHand):
    ...
    def __init__(self):
        super().__init__(
            name="Photon Sphere Scepter",
            description="Crafted to harness the pure, devastating power of the "
...
class LightCrossbow(Crossbow):
    ...
    def __init__(self):
        super().__init__(
            "Light Crossbow",
            "A light, dependable off-hand crossbow.",
            6000,
            0.6,
            16,
            5,
...
class HeavyCrossbow(Crossbow):
    ...
    def __init__(self):
        super().__init__(
            "Heavy Crossbow",
            "A weighty crossbow with substantial force.",
            12000,
            0.5,
            20,
            12,
...
class PistolCrossbow(Crossbow):
    ...
    def __init__(self):
        super().__init__(
            "Pistol Crossbow",
            "A powerful crossbow in a compact frame.",
            48000,
            0.4,
            24,
            6,
