...
HUMAN_STATUS_RESIST_MULTIPLIER: float = (
    0.90  # affects resisted-status contest scores (lower = worse resist)
)
...
GNOME_ENCUMBERED_HIT_MULTIPLIER: float = (
    0.85  # extra hit penalty while encumbered (stacks w/ ENCUMBERED_HIT_MULTIPLIER)
)
