...
class EnhancedBattleManager(BaseBattleManager):
    ...
    def __init__(self, game: Any, enemy: Character, logger=None, use_queue: bool = True,
                 battle_ui=None, battle_popup=None, textbox=None):
        """
        Args:
            ...
            battle_ui: UI component for battle display
            battle_popup: UI component for battle popups
            textbox: UI component for text display
        """
        super().__init__(game, enemy, logger, battle_ui, battle_popup, textbox)
