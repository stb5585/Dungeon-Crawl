...
@pytest.mark.parametrize(
    ...
    [
        ("Crusader", "Dormant Vow Affirmation", "Vow Trial"),
        ("Dragoon", "Dormant +1 Jump Mod", "Guard The Fall"),
        ...
        ("Knight Enchanter", "Dormant Mana Tap+", "Arcane Duel"),
        ("Grand Summoner", "Dormant +30% Summons", "Conduit Ritual"),
        ("Seeker", "Dormant Hidden Cache", "Cartographer's Proof"),
        ("Ninja", "Dormant First Strike Plus", "No-Trace Contract"),
        ("Arcane Trickster", "Dormant Spell Steal Buff", "Impossible Theft"),
        ...
        ("Lycan", "Dormant Controlled Frenzy", "Control Rite"),
        ("Astromancer", "Dormant Constellation Cycle", "Star Chart"),
        ("Soulcatcher", "Dormant Aspect Evolution", "Ancestral Totem Rite"),
        ("Beast Master", "Dormant Shared Recovery", "Pack Trial"),
    ],
)
